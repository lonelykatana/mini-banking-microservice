...
public class OnlineTransfer implements TransferStrategy {
    ...
    private static final Logger logger = LoggerFactory.getLogger(OnlineTransfer.class);

    @Override
    public void transfer(String fromAccount, String toAccount, BigDecimal amount) {
        logger.info("Processing ONLINE transfer");

        // can implement different logic for different transfer

        BigDecimal fee = masterDataClient.getFee("ONLINE_FEE", "TRANSFER");
